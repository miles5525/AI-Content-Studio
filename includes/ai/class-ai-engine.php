...
final class AICS_AI_Engine {
	...
	public function generate_automation_article( array $business_context, array $content_settings, array $idea ): AICS_AI_Response {
		...
		$article = $this->post_generator->validate_and_prepare_article( $data['article'], sanitize_key( (string) ( $content_settings['article_length'] ?? '' ) ), ! empty( $content_settings['allow_tables'] ) );
