...
final class AICS_Automations_Page {
	...
	private static function render_summary( array $profile ): void {
		...
		</div><?php if($active):?><p class="aics-automation-info"><?php esc_html_e('Your automation configuration is enabled. Due cycles can generate persistent ideas; evaluation, articles, and publishing are not connected yet.','ai-content-studio');?></p><?php endif;?></div></section>
		<?php
	}
	...
	private static function render_notice(): void {
		...
		$map  = array(
			...
			'automation_enabled' => array( 'success', __( 'Automation configuration saved and enabled. Due cycles can generate ideas; evaluation and later workflow steps are not connected yet.', 'ai-content-studio' ) ),
