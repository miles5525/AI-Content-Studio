...
final class AICS_SEO_State {
	...
	private const TRANSITIONS=array('not_requested'=>array('pending','skipped'),'pending'=>array('generating','skipped'),'generating'=>array('generated','retrying','failed','needs_attention'),'generated'=>array('review_required','approved'),'review_required'=>array('approved','needs_attention'),'approved'=>array('applied','needs_attention'),'retrying'=>array('generating','failed','needs_attention'),'failed'=>array('retrying','needs_attention','skipped'),'needs_attention'=>array('pending','retrying','skipped'),'applied'=>array(),'skipped'=>array());
