...
require_once AICS_PLUGIN_DIR . 'includes/services/class-manual-wizard-state-service.php';
require_once AICS_PLUGIN_DIR . 'includes/services/class-setup-wizard-state-service.php';
require_once AICS_PLUGIN_DIR . 'includes/services/class-content-history-query-service.php';
...
require_once AICS_PLUGIN_DIR . 'includes/admin/class-manual-studio-wizard-controller.php';
require_once AICS_PLUGIN_DIR . 'includes/admin/class-setup-wizard-page.php';
